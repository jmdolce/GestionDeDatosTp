...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_WIFI = 1)
    BEGIN
    ...
    IF EXISTS (SELECT 1 FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_CABLE = 1)
    BEGIN
        INSERT INTO LOS_GDDS.Caracteristica_inmueble(caracteristica_id, inmueble_id)
        SELECT DISTINCT c.id, i.id
        FROM gd_esquema.Maestra m
    ...
    IF EXISTS (SELECT 1 FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_CALEFACCION = 1)
    BEGIN
        INSERT INTO LOS_GDDS.Caracteristica_inmueble(caracteristica_id, inmueble_id)
        SELECT DISTINCT c.id, i.id
        FROM gd_esquema.Maestra m
    ...
    IF EXISTS (SELECT 1 FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_GAS = 1)
    BEGIN
        INSERT INTO LOS_GDDS.Caracteristica_inmueble(caracteristica_id, inmueble_id)
        SELECT DISTINCT c.id, i.id
        FROM gd_esquema.Maestra m
